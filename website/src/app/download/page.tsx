    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="card hover:border-gray-700 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-gray-600 to-gray-700 rounded-xl flex items-center justify-center text-2xl">📦</div>
            <div>
      ...
      <div className="card border-green-500/20">
        <h3 className="font-bold text-lg mb-4 text-green-400">🖥️ Requisiti di Sistema</h3>
